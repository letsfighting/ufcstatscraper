...
def entrymaker(fightid, year):
  ...
  if profilef1 is None or profilef2 is None:
    ...
    entry = {'_id': fightid, 'year': year, 'fighter1_id': profilef1['_id'], 'fighter1_name': profilef1['name'], 'fighter2_id': profilef2['_id'], 'fighter2_name': profilef2['name'], 'winner': winner, 'weight_class': allfightdetailsquery['weight_class'], 'method': method, 'end_round': allfightdetailsquery['round_finish'], 'fighter1_wins': profilef1['wins'], 'fighter1_losses': profilef1['losses'], 'fighter1_draws': profilef1['draws'], 'fighter1_ncs': profilef1['ncs'], 'fighter1_wko': profilef1['wko'], 'fighter1_wsub': profilef1['wsub'], 'fighter1_wdec': profilef1['wdec'], 'fighter1_wdq': profilef1['wdq'], 'fighter1_lko': profilef1['lko'], 'fighter1_lsub': profilef1['lsub'], 'fighter1_ldec': profilef1['ldec'], 'fighter1_ldq': profilef1['ldq'], 'fighter1_rounds_fought': profilef1['rounds_fought'], 'fighter1_total_time_fought': profilef1['duration'], 'fighter1_height': bio1['height'], 'fighter1_weight': bio1['weight'], 'fighter1_height': bio1['reach'], 'fighter1_reach': bio1['reach'], 'fighter1_stance': bio1['stance'], 'fighter1_birthyear': bio1['dob'], 'fighter1_KD': profilef1['KD'], 'fighter1_SS': profilef1['SS'], 'fighter1_SSA': profilef1['SSA'], 'fighter1_TD': profilef1['TD'], 'fighter1_TDA': profilef1['TDA'], 'fighter1_SUBATT': profilef1['SUBATT'], 'fighter1_REV': profilef1['REV'], 'fighter1_CTRL': profilef1['CTRL'], 'fighter1_HS': profilef1['HS'], 'fighter1_HSA': profilef1['HSA'], 'fighter1_BS': profilef1['BS'], 'fighter1_BSA': profilef1['BSA'], 'fighter1_LS': profilef1['LS'], 'fighter1_LSA': profilef1['LSA'], 'fighter1_DS': profilef1['DS'], 'fighter1_DSA': profilef1['DSA'], 'fighter1_CS': profilef1['CS'], 'fighter1_CSA': profilef1['CSA'], 'fighter1_GS': profilef1['GS'], 'fighter1_GSA': profilef1['GSA'], 'fighter1_DOWNED': profilef1['Downed'], 'fighter1_SSD': profilef1['SSD'], 'fighter1_SSR': profilef1['SSR'], 'fighter1_TDD': profilef1['TDD'], 'fighter1_TDR': profilef1['TDR'], 'fighter1_REVED': profilef1['REVED'], 'fighter1_CTRLED': profilef1['CTRLED'], 'fighter1_HSD': profilef1['HSD'], 'fighter1_HSR': profilef1['HSR'], 'fighter1_BSD': profilef1['BSD'], 'fighter1_BSR': profilef1['BSR'], 'fighter1_LSD': profilef1['LSD'], 'fighter1_LSR': profilef1['LSR'], 'fighter1_DSD': profilef1['DSD'], 'fighter1_DSR': profilef1['DSR'], 'fighter1_CSD': profilef1['CSD'], 'fighter1_CSR': profilef1['CSR'], 'fighter1_GSD': profilef1['GSD'], 'fighter1_GSR': profilef1['GSR'],
